...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">จัดการประเภทอาหาร</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">เพิ่มประเภทอาหาร</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="insert_cat.php" method="post" enctype="multipart/form-data" id="form1">
            ...
            <div class="form-group">
                            ...
                            <input type="file" name="categories_img">
            </div>
...
?>
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><?php echo $objResult["categories_id"];?></td>
                                        <td><?php echo $objResult["categories_name"];?></td>
                                        <td><img id="foodimg" class="rounded" height="42" width="42" src="img/<?php echo $objResult["categories_img"];?>"></td>
                                        <td>
            ...
            <a href="#edit<?php echo $objResult["categories_id"];?>" data-toggle="modal">
  ...
  <!-- Modal -->
<div id="edit<?php echo $objResult["categories_id"];?>" class="modal fade" id="editMo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                           <form action="update_cat.php" method="post" >

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">แก้ไขประเภทอาหาร</h3>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">          
        <div class="form-group">
                                                ...
                                                <label for="exampleInputCategories">เลขประเภทอาหาร : <?php echo $objResult["categories_id"];?></label>
</div>
          <div class="form-group">
                            <label for="exampleInputCategories">ชื่อประเภทอาหาร</label>
                            <input name="categories_name" type="text" class="form-control" id="exampleInputCategories" 
                            value="<?php echo $objResult['categories_name'];?>">
                        </div>
                                <div class="form-group">
      ...
      <div class="modal-footer">
        <div align ="right">
                        <input type="hidden" name="categories_id" value="<?php echo $objResult['categories_id'];?>">
                        ...
                        <button type="reset" class="btn btn-danger" value="cancel" data-dismiss="modal">ยกเลิก</button>
                                                ...
                                                <a href="delete-cat.php?categories_id=<?php echo $objResult['categories_id'];?>" onclick="return confirm('คุณต้องการจะลบหรือไม่')">
